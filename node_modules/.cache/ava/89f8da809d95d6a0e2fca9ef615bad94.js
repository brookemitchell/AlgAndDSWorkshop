...
test.only('implement cocktail sort', function (t) {
    var _rec9 = new _powerAssertRecorder(),
        _rec10 = new _powerAssertRecorder(),
        _rec11 = new _powerAssertRecorder();

    t.truthy(_rec9._expr(_rec9._capt(cocktailSort, 'arguments/0'), {
        content: 't.truthy(cocktailSort)',
        filepath: 'bubbleSort.js',
        line: 65,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"truthy","range":[2,8]},"computed":false,"range":[0,8]},"arguments":[{"type":"Identifier","name":"cocktailSort","range":[9,21]}],"range":[0,22]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"truthy","range":[2,8]},{"type":{"label":"("},"range":[8,9]},{"type":{"label":"name"},"value":"cocktailSort","range":[9,21]},{"type":{"label":")"},"range":[21,22]}]',
        visitorKeys: _powerAssertVisitorKeys
    }));
    var arr = [3, 5, 1];
    ...
    t.deepEqual(_rec10._expr(_rec10._capt(act, 'arguments/0'), {
        content: 't.deepEqual(act, exp)',
        filepath: 'bubbleSort.js',
        line: 72,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"act","range":[12,15]},{"type":"Identifier","name":"exp","range":[17,20]}],"range":[0,21]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"act","range":[12,15]},{"type":{"label":","},"range":[15,16]},{"type":{"label":"name"},"value":"exp","range":[17,20]},{"type":{"label":")"},"range":[20,21]}]',
        visitorKeys: _powerAssertVisitorKeys
    }), _rec11._expr(_rec11._capt(exp, 'arguments/1'), {
        content: 't.deepEqual(act, exp)',
        filepath: 'bubbleSort.js',
        line: 72,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"act","range":[12,15]},{"type":"Identifier","name":"exp","range":[17,20]}],"range":[0,21]}',
...
//# sourceMappingURL=../node_modules/.cache/ava/89f8da809d95d6a0e2fca9ef615bad94.js.map