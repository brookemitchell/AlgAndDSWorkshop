...
function selSort(arr) {
    for (var i = 0; i < arr.length; i++) {
        ...
        for (var j = i, selected = arr[i]; i < arr.length; j++) {
            if (arr[j] > selected) {
                selected = arr[j];
            }
        }
...
test('implement selection sort', function (t) {
...
//# sourceMappingURL=../node_modules/.cache/ava/4b88f0126a30f4c5e72f921f817e8733.js.map