...
var _typeof2 = require('/Users/brooke/Projects/AlgAndDSWorkshop/node_modules/babel-runtime/helpers/typeof.js');
...
test('implement min method', function (t) {
    ...
    t.is(_rec._expr(_rec._capt((0, _typeof3.default)(_rec._capt(_rec._capt(s1, 'arguments/0/argument/object').min, 'arguments/0/argument')), 'arguments/0'), {
        content: 't.is(typeof s1.min, \'function\')',
        filepath: 'stackObjectExercises.test.js',
        line: 27,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"is","range":[2,4]},"computed":false,"range":[0,4]},"arguments":[{"type":"UnaryExpression","operator":"typeof","argument":{"type":"MemberExpression","object":{"type":"Identifier","name":"s1","range":[12,14]},"property":{"type":"Identifier","name":"min","range":[15,18]},"computed":false,"range":[12,18]},"prefix":true,"range":[5,18]},{"type":"StringLiteral","value":"function","range":[20,30]}],"range":[0,31]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"is","range":[2,4]},{"type":{"label":"("},"range":[4,5]},{"type":{"label":"typeof"},"value":"typeof","range":[5,11]},{"type":{"label":"name"},"value":"s1","range":[12,14]},{"type":{"label":"."},"range":[14,15]},{"type":{"label":"name"},"value":"min","range":[15,18]},{"type":{"label":","},"range":[18,19]},{"type":{"label":"string"},"value":"function","range":[20,30]},{"type":{"label":")"},"range":[30,31]}]',
    ...
    t.is(_rec2._expr(_rec2._capt(act, 'arguments/0'), {
    ...
    console.log(s1._min);
    console.log(s2._min);
    t.is(_rec4._expr(_rec4._capt(act1, 'arguments/0'), {
        ...
        visitorKeys: _powerAssertVisitorKeys
    }), _rec5._expr(_rec5._capt(exp1, 'arguments/1'), {
        content: 't.is(act1, exp1)',
        filepath: 'stackObjectExercises.test.js',
        line: 39,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"is","range":[2,4]},"computed":false,"range":[0,4]},"arguments":[{"type":"Identifier","name":"act1","range":[5,9]},{"type":"Identifier","name":"exp1","range":[11,15]}],"range":[0,16]}',
...
//# sourceMappingURL=node_modules/.cache/ava/8c36278c369061a211951816456ade27.js.map