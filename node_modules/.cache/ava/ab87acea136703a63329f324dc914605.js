...
test('recursiveMultiplier', function (t) {
    ...
    t.deepEqual(_rec3._expr(_rec3._capt(act, 'arguments/0'), {
        ...
        visitorKeys: _powerAssertVisitorKeys
    }), _rec4._expr(_rec4._capt(exp, 'arguments/1'), {
        content: 't.deepEqual(act, exp)',
        filepath: 'i.js',
        line: 68,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"act","range":[12,15]},{"type":"Identifier","name":"exp","range":[17,20]}],"range":[0,21]}',
    ...
    t.deepEqual(_rec9._expr(_rec9._capt(act4, 'arguments/0'), {
        content: 't.deepEqual(act4, exp4)',
        filepath: 'i.js',
        line: 71,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"act4","range":[12,16]},{"type":"Identifier","name":"exp4","range":[18,22]}],"range":[0,23]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"act4","range":[12,16]},{"type":{"label":","},"range":[16,17]},{"type":{"label":"name"},"value":"exp4","range":[18,22]},{"type":{"label":")"},"range":[22,23]}]',
        visitorKeys: _powerAssertVisitorKeys
    }), _rec10._expr(_rec10._capt(exp4, 'arguments/1'), {
        content: 't.deepEqual(act4, exp4)',
        filepath: 'i.js',
        line: 71,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"act4","range":[12,16]},{"type":"Identifier","name":"exp4","range":[18,22]}],"range":[0,23]}',
...
function recursiveReverse(arr) {
    ...
    return [arr[arr.length - 1]].concat(recursiveReverse(arr.slice(0, arr.length - 2)));
}

test.only('recursiveReverse', function (t) {
    ...
    t.deepEqual(_rec11._expr(_rec11._capt(act, 'arguments/0'), {
        content: 't.deepEqual(act, exp)',
        filepath: 'i.js',
        line: 91,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"act","range":[12,15]},{"type":"Identifier","name":"exp","range":[17,20]}],"range":[0,21]}',
    ...
    t.deepEqual(_rec13._expr(_rec13._capt(act2, 'arguments/0'), {
        content: 't.deepEqual(act2, exp2)',
        filepath: 'i.js',
        line: 92,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"act2","range":[12,16]},{"type":"Identifier","name":"exp2","range":[18,22]}],"range":[0,23]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"act2","range":[12,16]},{"type":{"label":","},"range":[16,17]},{"type":{"label":"name"},"value":"exp2","range":[18,22]},{"type":{"label":")"},"range":[22,23]}]',
        visitorKeys: _powerAssertVisitorKeys
    }), _rec14._expr(_rec14._capt(exp2, 'arguments/1'), {
        content: 't.deepEqual(act2, exp2)',
        filepath: 'i.js',
        line: 92,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"act2","range":[12,16]},{"type":"Identifier","name":"exp2","range":[18,22]}],"range":[0,23]}',
...
//# sourceMappingURL=node_modules/.cache/ava/ab87acea136703a63329f324dc914605.js.map