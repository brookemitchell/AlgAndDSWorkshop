...
test.only('dequeues correctly', function (t) {
    ...
    t.is(_rec._expr(_rec._capt(act, 'arguments/0'), {
        content: 't.is(act, \'one\')',
        filepath: 'i.js',
        line: 50,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"is","range":[2,4]},"computed":false,"range":[0,4]},"arguments":[{"type":"Identifier","name":"act","range":[5,8]},{"type":"StringLiteral","value":"one","range":[10,15]}],"range":[0,16]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"is","range":[2,4]},{"type":{"label":"("},"range":[4,5]},{"type":{"label":"name"},"value":"act","range":[5,8]},{"type":{"label":","},"range":[8,9]},{"type":{"label":"string"},"value":"one","range":[10,15]},{"type":{"label":")"},"range":[15,16]}]',
...
//# sourceMappingURL=node_modules/.cache/ava/a0cdcd83df3ce4d1f380ba7d744546d2.js.map