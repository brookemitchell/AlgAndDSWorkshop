...
test.only('implement cocktail sort', function (t) {
    ...
    t.truthy(_rec9._expr(_rec9._capt(cocktailAort, 'arguments/0'), {
        content: 't.truthy(cocktailAort)',
        filepath: 'bubbleSort.js',
        line: 64,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"truthy","range":[2,8]},"computed":false,"range":[0,8]},"arguments":[{"type":"Identifier","name":"cocktailAort","range":[9,21]}],"range":[0,22]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"truthy","range":[2,8]},{"type":{"label":"("},"range":[8,9]},{"type":{"label":"name"},"value":"cocktailAort","range":[9,21]},{"type":{"label":")"},"range":[21,22]}]',
        visitorKeys: _powerAssertVisitorKeys
    }));
});
//# sourceMappingURL=../node_modules/.cache/ava/2b0b6f1c550f124e9322f585720f5ccd.js.map