...
function swap(arr) {
    ...
    var hi = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : arr.length;
    ...
    while (pivLoc < pivot) {
        if (arr[pivLoc] <= arr[pivot]) {
            pivLoc++;
        } else {
            var cur = arr[pivLoc];
            var piv = arr[pivot];
            var pivMin1 = arr[pivot - 1];
            // swap pivLoc and pivot
            arr[pivot] = cur; // [ 1, 8, 2, 9, 7, 8 ]
            arr[pivLoc] = piv; // [ 1, 4, 2, 9, 7, 8 ]
            // swap piv - 1 and pivLoc
            arr[pivot - 1] = piv; // [ 1, 4, 2, 9, 4, 8 ]
            arr[pivLoc] = pivMin1; // [ 1, 7, 2, 9, 4, 8 ]
...
//# sourceMappingURL=../node_modules/.cache/ava/386856757decb5ab6583479e392351da.js.map