...
var _toConsumableArray2 = require('/Users/brooke/Projects/AlgAndDSWorkshop/node_modules/babel-runtime/helpers/toConsumableArray.js');
...
test('swaps pivot to correct point', function (t) {
    ...
    swap(arr);
    var exp = [1, 2, 4, 9, 7, 8];
    t.deepEqual(_rec._expr(_rec._capt(arr, 'arguments/0'), {
        content: 't.deepEqual(arr, exp)',
        filepath: 'quickSort.js',
        line: 38,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"arr","range":[12,15]},{"type":"Identifier","name":"exp","range":[17,20]}],"range":[0,21]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"arr","range":[12,15]},{"type":{"label":","},"range":[15,16]},{"type":{"label":"name"},"value":"exp","range":[17,20]},{"type":{"label":")"},"range":[20,21]}]',
    ...
    swap(arr2);
    var exp2 = [2, 4, 9, 7, 8];
    t.deepEqual(_rec3._expr(_rec3._capt(arr2, 'arguments/0'), {
        content: 't.deepEqual(arr2, exp2)',
        filepath: 'quickSort.js',
        line: 43,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"arr2","range":[12,16]},{"type":"Identifier","name":"exp2","range":[18,22]}],"range":[0,23]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"arr2","range":[12,16]},{"type":{"label":","},"range":[16,17]},{"type":{"label":"name"},"value":"exp2","range":[18,22]},{"type":{"label":")"},"range":[22,23]}]',
        visitorKeys: _powerAssertVisitorKeys
    ...
    swap(arr3);
    var exp3 = [4, 7, 9];
    t.deepEqual(_rec5._expr(_rec5._capt(arr3, 'arguments/0'), {
        content: 't.deepEqual(arr3, exp3)',
        filepath: 'quickSort.js',
        line: 48,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"arr3","range":[12,16]},{"type":"Identifier","name":"exp3","range":[18,22]}],"range":[0,23]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"arr3","range":[12,16]},{"type":{"label":","},"range":[16,17]},{"type":{"label":"name"},"value":"exp3","range":[18,22]},{"type":{"label":")"},"range":[22,23]}]',
        visitorKeys: _powerAssertVisitorKeys
...
function quickSort(arr) {
    ...
    var piv = arr[arr.length - 1];
    var swapped = swap(arr);

    var left = swapped.filter(function (e) {
        return e < piv;
    });
    var mid = swapped.filter(function (e) {
        return e === piv;
    });
    var right = swapped.filter(function (e) {
        return e > piv;
    });

    return [].concat((0, _toConsumableArray3.default)(quickSort(left)), (0, _toConsumableArray3.default)(mid), (0, _toConsumableArray3.default)(quickSort(right)));
}

test('run a quickSort', function (t) {
    var _rec7 = new _powerAssertRecorder(),
        _rec8 = new _powerAssertRecorder();

    var arr = [1, 8, 2, 9, 7, 4];
    var act = quickSort(arr);
    var exp = [1, 2, 4, 7, 8, 9];
    t.deepEqual(_rec7._expr(_rec7._capt(act, 'arguments/0'), {
        ...
        visitorKeys: _powerAssertVisitorKeys
    }), _rec8._expr(_rec8._capt(exp, 'arguments/1'), {
        content: 't.deepEqual(act, exp)',
        filepath: 'quickSort.js',
        line: 68,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"act","range":[12,15]},{"type":"Identifier","name":"exp","range":[17,20]}],"range":[0,21]}',
...
test('handle doubles', function (t) {
    var _rec9 = new _powerAssertRecorder(),
        _rec10 = new _powerAssertRecorder();

    var arr2 = [1, 8, 2, 9, 2, 7, 4];
    var act2 = quickSort(arr2);
    var exp2 = [1, 2, 2, 4, 7, 8, 9];
    t.deepEqual(_rec9._expr(_rec9._capt(act2, 'arguments/0'), {
...
//# sourceMappingURL=../node_modules/.cache/ava/10ace40b68b5ab28ee2c234abbf8c712.js.map