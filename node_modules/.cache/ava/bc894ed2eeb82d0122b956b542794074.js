...
function swap(arr) {
    ...
    for (var i = 0, begin = 0, piv = arr.length - 1; begin < arr.length - 1; i++) {

        console.log(arr, arr[piv], i, begin);
        if (arr[i] <= arr[piv]) {
            begin = i;
            begin++;
        } else {
...
//# sourceMappingURL=../node_modules/.cache/ava/bc894ed2eeb82d0122b956b542794074.js.map