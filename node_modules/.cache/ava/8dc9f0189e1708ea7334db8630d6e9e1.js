...
var _slicedToArray2 = require('/Users/brooke/Projects/AlgAndDSWorkshop/node_modules/babel-runtime/helpers/slicedToArray.js');
...
function merge(arr1, arr2) {
    ...
    for (var i = 0, j = 0; i < arr1.length && j < arr2.length;) {
        console.log(arr1[i], i < arr1.length, arr2[j], j < arr2.length);
        if (arr1[i] > arr2[j]) {
            ret.push(arr2[j]);
            j++;
        }
        console.log(arr1[i], i < arr1.length, arr2[j], j < arr2.length, i < arr1.length, arr2[j] && j < arr2.length);
    }
    return ret;
}
test.only('merge two single el presorted arrays', function (t) {
    var _rec = new _powerAssertRecorder(),
        _rec2 = new _powerAssertRecorder();

    var arr1 = [5];
    var arr2 = [2];
    var act = merge(arr1, arr2);
    var exp = [2, 5];
    t.deepEqual(_rec._expr(_rec._capt(act, 'arguments/0'), {
        content: 't.deepEqual(act, exp)',
        filepath: 'mergeSort.js',
        line: 48,
...
test('merge two presorted arrays', function (t) {
...
test('split an array in two', function (t) {
    ...
    var act = split(array);
    var exp = [[1, 2], [4, 5, 9]];
    t.deepEqual(_rec5._expr(_rec5._capt(act, 'arguments/0'), {
        content: 't.deepEqual(act, exp)',
        filepath: 'mergeSort.js',
        line: 76,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"act","range":[12,15]},{"type":"Identifier","name":"exp","range":[17,20]}],"range":[0,21]}',
...
test('return if array len 1', function (t) {
    var _rec7 = new _powerAssertRecorder(),
        _rec8 = new _powerAssertRecorder();

    var array = [1];
    var act = mergeSort(array);
    var exp = [1];
...
test('split in 2 correctly', function (t) {
    ...
    var act = mergeSort(array);
    var exp = [[1, 2], [4, 5, 9]];
    t.deepEqual(_rec9._expr(_rec9._capt(act, 'arguments/0'), {
        content: 't.deepEqual(act, exp)',
        filepath: 'mergeSort.js',
        line: 91,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"act","range":[12,15]},{"type":"Identifier","name":"exp","range":[17,20]}],"range":[0,21]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"act","range":[12,15]},{"type":{"label":","},"range":[15,16]},{"type":{"label":"name"},"value":"exp","range":[17,20]},{"type":{"label":")"},"range":[20,21]}]',
        visitorKeys: _powerAssertVisitorKeys
    }), _rec10._expr(_rec10._capt(exp, 'arguments/1'), {
        content: 't.deepEqual(act, exp)',
        filepath: 'mergeSort.js',
        line: 91,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"act","range":[12,15]},{"type":"Identifier","name":"exp","range":[17,20]}],"range":[0,21]}',
...
test('sort correctly  when 2 left', function (t) {
...
//# sourceMappingURL=../node_modules/.cache/ava/8dc9f0189e1708ea7334db8630d6e9e1.js.map