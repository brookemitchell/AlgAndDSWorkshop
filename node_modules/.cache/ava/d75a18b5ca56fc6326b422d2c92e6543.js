...
test('number of pops until get certain value', function (t) {
    ...
    t.is(_rec11._expr(_rec11._capt(act3, 'arguments/0'), {
        content: 't.is(act3, exp3)',
        filepath: 'stackObject.test.js',
        line: 53,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"is","range":[2,4]},"computed":false,"range":[0,4]},"arguments":[{"type":"Identifier","name":"act3","range":[5,9]},{"type":"Identifier","name":"exp3","range":[11,15]}],"range":[0,16]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"is","range":[2,4]},{"type":{"label":"("},"range":[4,5]},{"type":{"label":"name"},"value":"act3","range":[5,9]},{"type":{"label":","},"range":[9,10]},{"type":{"label":"name"},"value":"exp3","range":[11,15]},{"type":{"label":")"},"range":[15,16]}]',
        visitorKeys: _powerAssertVisitorKeys
    }), _rec12._expr(_rec12._capt(exp3, 'arguments/1'), {
        content: 't.is(act3, exp3)',
        filepath: 'stackObject.test.js',
        line: 53,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"is","range":[2,4]},"computed":false,"range":[0,4]},"arguments":[{"type":"Identifier","name":"act3","range":[5,9]},{"type":"Identifier","name":"exp3","range":[11,15]}],"range":[0,16]}',
    ...
    t.is(_rec13._expr(_rec13._capt(actT, 'arguments/0'), {
        content: 't.is(actT, expT)',
        filepath: 'stackObject.test.js',
        line: 66,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"is","range":[2,4]},"computed":false,"range":[0,4]},"arguments":[{"type":"Identifier","name":"actT","range":[5,9]},{"type":"Identifier","name":"expT","range":[11,15]}],"range":[0,16]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"is","range":[2,4]},{"type":{"label":"("},"range":[4,5]},{"type":{"label":"name"},"value":"actT","range":[5,9]},{"type":{"label":","},"range":[9,10]},{"type":{"label":"name"},"value":"expT","range":[11,15]},{"type":{"label":")"},"range":[15,16]}]',
        visitorKeys: _powerAssertVisitorKeys
    }), _rec14._expr(_rec14._capt(expT, 'arguments/1'), {
        content: 't.is(actT, expT)',
        filepath: 'stackObject.test.js',
        line: 66,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"is","range":[2,4]},"computed":false,"range":[0,4]},"arguments":[{"type":"Identifier","name":"actT","range":[5,9]},{"type":"Identifier","name":"expT","range":[11,15]}],"range":[0,16]}',
...
//# sourceMappingURL=node_modules/.cache/ava/d75a18b5ca56fc6326b422d2c92e6543.js.map