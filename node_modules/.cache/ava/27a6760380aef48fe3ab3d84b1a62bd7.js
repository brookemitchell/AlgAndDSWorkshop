...
test('inserts new head', function (t) {
  ...
  var exp = new LinkedList(Node.of(0, Node.of(1, Node.of(99))));
  console.log(full(act), full(exp));
...
1 1 5 6   (1 -> 1 -> 5 -> 6)
 */
//# sourceMappingURL=../node_modules/.cache/ava/27a6760380aef48fe3ab3d84b1a62bd7.js.map